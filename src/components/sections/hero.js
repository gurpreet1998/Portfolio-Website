...
const Hero = () => {
  ...
  const two = <h2 className="big-heading">Gurpreet Singh.</h2>;
  const three = <h1 className="big-heading">Graduate Student at Santa Clara University</h1>;
  const four = (
    <>
      <p>
  ...
  const five = (
    <a className="email-link" href="/Gurpreet_Singh_Resume.pdf" target="_blank" rel="noreferrer">
      Download my Resume!
    </a>
  );
