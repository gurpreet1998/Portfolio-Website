      ...
      edges: [
        {
          node: {
            frontmatter: {
              ...
              tech: ['VS Code', 'ReactJs', 'HTML5/CSS3', '.Net Core', 'C#', 'Entity Framework'],
              github: 'https://github.com/gurpreet1998/jewellers-munim',
              external: 'https://vigorous-knuth-119b35.netlify.app/',
              cta: null,
            },
            html:
              '<p>A Cloud based ERP Jewellery platform for reducing jewellery store management overhead</p>',
          },
        },
      ],
    },
